...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getNewPriceHtmlBox($product)
    {
        ...
        $html = sprintf('<div class="price-box price-final_price" data-product-id="%d">%s</div>', $product->getId(), '<article class="additional-info"><span class="p-label"></span><h3 class="p-title"></h3><span class="p-sub"></span></article>');
