...
namespace Amasty\Customform\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_customform_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_Customform::css/source/mkcss/amcform.css');
        }
