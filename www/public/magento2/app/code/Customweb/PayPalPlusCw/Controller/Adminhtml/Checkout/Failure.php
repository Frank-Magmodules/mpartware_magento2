...
class Failure extends \Customweb\PayPalPlusCw\Controller\Adminhtml\Checkout
{
	public function execute()
	{
		...
		if (empty($sameSiteFix)) {
			...
			return $this->resultRedirectFactory->create()->setPath('paypalpluscw/checkout/failure', [
