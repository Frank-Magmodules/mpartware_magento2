...
class Iframe extends \Customweb\PayPalPlusCw\Controller\Checkout
{
	public function execute()
	{
		try {
			$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
			/* @var $authorizationMethodAdapter \Customweb\PayPalPlusCw\Model\Authorization\Method\Iframe */
			...
			$resultPage->getLayout()
				->getBlock('customweb_paypalpluscwcheckout_iframe')
