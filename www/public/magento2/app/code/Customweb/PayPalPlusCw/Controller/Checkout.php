...
namespace Customweb\PayPalPlusCw\Controller;
...
abstract class Checkout extends \Magento\Framework\App\Action\Action
{
	 ...
	 */
	protected function handleSuccess(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 */
	protected function handleFailure(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction, $errorMessage)
	{
		$this->_checkoutSession->setLastRealOrderId($transaction->getOrder()->getRealOrderId());
		$this->restoreQuote();

		$this->messageManager->addErrorMessage($errorMessage);
// 		$this->_checkoutSession->setPayPalPlusCwFailureMessage($errorMessage);
