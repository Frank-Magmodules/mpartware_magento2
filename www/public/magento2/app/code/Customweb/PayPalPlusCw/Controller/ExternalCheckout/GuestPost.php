...
class GuestPost extends \Customweb\PayPalPlusCw\Controller\ExternalCheckout
{
	/**
	...
	public function execute()
	{
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\PayPalPlusCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
			$data = [
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST))) {
