...
namespace Customweb\PayPalPlusCw\Controller\Adminhtml;
...
abstract class Transaction extends \Magento\Backend\App\Action
{
	...
	protected function _initAction()
	{
		...
		$resultPage->setActiveMenu('Customweb_PayPalPlusCw::transactions');
		$resultPage->addBreadcrumb(__('Sales'), __('Sales'));
		$resultPage->addBreadcrumb('PayPal Plus', 'PayPal Plus');
		$resultPage->addBreadcrumb(__('PayPal Plus Transactions'), __('PayPal Plus Transactions'));
		return $resultPage;
	}
	 ...
	 *
	 * @return \Customweb\PayPalPlusCw\Model\Authorization\Transaction|false
	 */
	protected function _initTransaction()
	{
		...
		$this->_coreRegistry->register('paypalpluscw_transaction', $transaction);
		return $transaction;
	}

	protected function _isAllowed()
	{
		return $this->_authorization->isAllowed('Customweb_PayPalPlusCw::transactions');
	}
}