	...
	var AuthorizationMethod = function(formElement, authorizationUrl) {
		...
		this.redirect = function(orderId) {
			...
			if (!customer.isLoggedIn()) {
				serviceUrl = urlBuilder.createUrl('/guest-carts/:cartId/paypalpluscw/checkout/authorize', {
					cartId: quote.getQuoteId()
				});
			} else {
				serviceUrl = urlBuilder.createUrl('/carts/mine/paypalpluscw/checkout/authorize', {});
			}
			return storage.post(
