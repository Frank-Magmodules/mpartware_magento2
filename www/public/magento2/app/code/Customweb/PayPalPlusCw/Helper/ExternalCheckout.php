...
namespace Customweb\PayPalPlusCw\Helper;
...
class ExternalCheckout extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function validateCustomerData(\Magento\Quote\Model\Quote $quote, array $data, $registerMethod)
	{
		...
		if ($registerMethod == \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER) {
	 ...
	 */
	public function saveOrder(\Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context)
	{
		...
		switch ($context->getRegisterMethod()) {
			case \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST:
				$this->prepareGuestQuote($context);
				break;
			case \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER:
	 ...
	 * @param \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareGuestQuote(\Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareNewCustomerQuote(\Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareCustomerQuote(\Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context)
	{
		$billing = $context->getQuote()->getBillingAddress();
		$shipping = $context->getQuote()->isVirtual() ? null : $context->getQuote()->getShippingAddress();
	 ...
	 * @param \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context
	 */
	private function involveNewCustomer(\Customweb\PayPalPlusCw\Model\ExternalCheckout\Context $context)
	{
		$customer = $context->getQuote()->getCustomer();
