...
namespace Customweb\PayPalPlusCw\Plugin\Framework\App;

class Http
{

	/**
	 * @var \Customweb\PayPalPlusCw\Model\Logging\Listener
	 */
	private $_loggingListener;

	/**
	 * @param \Customweb\PayPalPlusCw\Model\Logging\Listener $loggingListener
	 */
	public function __construct(
			\Customweb\PayPalPlusCw\Model\Logging\Listener $loggingListener
	) {
	...
	{
		\Customweb_I18n_Translation::getInstance()->addResolver(new \Customweb\PayPalPlusCw\Model\TranslationResolver());
	}
