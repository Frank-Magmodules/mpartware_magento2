...
namespace Customweb\PayPalPlusCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\PayPalPlusCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_paypalpluscw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_paypalpluscw_external_checkout_context', 'context_id');
    }
