...
class TransactionHandler implements \Customweb_Payment_ITransactionHandler
{
	 ...
	 * @param mixed $value
	 * @param string $field
	 * @return null|\Customweb\PayPalPlusCw\Model\Authorization\Transaction
	 */
	 ...
	 */
	private function storeInCache(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction)
	{
