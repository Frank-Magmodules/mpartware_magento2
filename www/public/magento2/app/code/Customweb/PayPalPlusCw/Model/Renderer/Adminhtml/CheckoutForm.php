...
namespace Customweb\PayPalPlusCw\Model\Renderer\Adminhtml;

class CheckoutForm extends \Customweb\PayPalPlusCw\Model\Renderer\AbstractForm
{
	/**
	...
	public function __construct(
		...
		$this->setControlCssClassResolver(new \Customweb\PayPalPlusCw\Model\Renderer\Adminhtml\ControlCssClassResolver());

		$this->setFormCssClass('paypalpluscw_form');
