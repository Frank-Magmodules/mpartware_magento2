...
class TransactionRepository implements \Customweb\PayPalPlusCw\Api\TransactionRepositoryInterface
{
	/**
    ...
    /**
     * @var \Customweb\PayPalPlusCw\Api\Data\TransactionInterfaceFactory
     */
	 ...
	 * @param \Customweb\PayPalPlusCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory
	...
	public function __construct(
			...
			\Customweb\PayPalPlusCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory,
	...
	public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
	{
		...
		/** @var \Customweb\PayPalPlusCw\Model\ResourceModel\Authorization\Transaction\Collection $collection */
	 ...
	 *
	 * @return \Customweb\PayPalPlusCw\Api\Data\TransactionInterface
	 */
	protected function getDataModel(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction)
	{
		$transactionDataObject = $this->_transactionDataFactory->create();
		$this->_dataObjectHelper->populateWithArray(
				$transactionDataObject,
				$this->extractTransactionData($transaction),
				'\Customweb\PayPalPlusCw\Api\Data\TransactionInterface'
		);
		return $transactionDataObject;
	}

	private function extractTransactionData(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction)
	{
		...
		$data[\Customweb\PayPalPlusCw\Api\Data\TransactionInterface::TRANSACTION_DATA] = $transactionData;
		return $data;
	}
