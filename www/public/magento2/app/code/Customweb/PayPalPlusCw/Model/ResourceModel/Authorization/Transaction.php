...
namespace Customweb\PayPalPlusCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\PayPalPlusCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_paypalpluscw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_paypalpluscw_transaction', 'entity_id');
    }
