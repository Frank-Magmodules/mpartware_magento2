...
namespace Customweb\PayPalPlusCw\Model\Adapter;
...
class LayoutRenderer extends \Customweb_Mvc_Layout_Renderer
{
	...
	{
		$this->_view->loadLayout(['default', 'paypalpluscw_layout_renderer'], true, true, false);
		...
		$this->_view->getPage()->getConfig()->addPageAsset('Customweb_PayPalPlusCw::css/paypalpluscw.css');
	}
	...
	{
		$this->_view->getLayout()->addBlock('\Magento\Framework\View\Element\Text', 'paypalpluscw.main.content', 'content')->setText($content);
	}
