...
class Endpoint extends \Customweb_Payment_Endpoint_AbstractAdapter
{
	...
	protected function getBaseUrl() {
		return $this->_frontendUrlBuilder->setScope($this->_configuration->getStore())->getUrl('paypalpluscw/endpoint/index', ['_secure' => true, '_nosid' => true]);
	}
	...
	public function getFormRenderer() {
		return new \Customweb\PayPalPlusCw\Model\Renderer\FrontendForm();
	}
}