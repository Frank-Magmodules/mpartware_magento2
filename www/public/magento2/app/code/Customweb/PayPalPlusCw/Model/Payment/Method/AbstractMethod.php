 ...
 *
 */
namespace Customweb\PayPalPlusCw\Model\Payment\Method;
...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Customweb\PayPalPlusCw\Block\Payment\Method\Form';
	 ...
	 * @var string
	 */
	protected $_infoBlockType = 'Customweb\PayPalPlusCw\Block\Payment\Method\Info';
	...
	public function getOrderPlaceRedirectUrl()
	{
		...
		$transactionId = null;
		$transaction = $this->_registry->registry('paypalpluscw_transaction');
		if ($transaction instanceof \Customweb\PayPalPlusCw\Model\Authorization\Transaction) {
			$transactionId = $transaction->getId();
		}
		return $quote->getStore()->getUrl('paypalpluscw/checkout/error', [
			'_secure' => true,
	...
	public function validate()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_PayPalPlusCw_License::run('u4cvi1hd4quruan4', $this, $arguments);
	}

	final public function call_23knmvmv123fql23() {
	 ...
	 * @return \Customweb\PayPalPlusCw\Model\Payment\Method\AbstractMethod
	 */
	...
	public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		$transaction = $this->_registry->registry('paypalpluscw_authorization_transaction');
		if ($transaction instanceof \Customweb\PayPalPlusCw\Model\Authorization\Transaction) {
	...
	public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		try {
			...
			if ($transaction->getId()) {
				$invoice = $this->_registry->registry('paypalpluscw_invoice');
	...
	private function captureItems(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction, $items = [])
	{
