...
use \Customweb\PayPalPlusCw\Api\Data\TransactionInterface;
use Magento\Customer\Model\Customer;

/**
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setEntityId(int $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setTransactionExternalId(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setOrderId(int $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setOrderIncrementId(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setOrderPaymentId(int $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setAliasForDisplay(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setAliasActive(boolean $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setPaymentMethod(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setTransactionObject(\Customweb_Payment_Authorization_ITransaction $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setAuthorizationType(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setCustomerId(int $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setUpdatedOn(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setCreatedOn(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setPaymentId(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setExecuteUpdateOn(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setAuthorizationAmount(float $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setAuthorizationStatus(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setPaid(boolean $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setLiveTransaction(boolean $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setCurrency(string $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setSendEmail(boolean $value)
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\PayPalPlusCw\Model\Authorization\Transaction setVersionNumber(int $value)
 */
class Transaction extends \Magento\Framework\Model\AbstractModel implements \Magento\Sales\Model\EntityInterface, TransactionInterface
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_paypalpluscw_transaction';
	 ...
	 * @var string
	 */
	protected $_entityType = 'paypluscw_trx';
	...
	{
		$this->_init('Customweb\PayPalPlusCw\Model\ResourceModel\Authorization\Transaction');
	}
	...
	public function afterSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof \Customweb_Payment_Authorization_ITransaction) {
			...
			if ($customerContext instanceof \Customweb\PayPalPlusCw\Model\Authorization\CustomerContext) {
				try {
		...
		if ($this->_registry->registry('initializeTransaction') !== false && $this->getTransactionObject() == null) {
			...
			/* @var $adapter \Customweb\PayPalPlusCw\Model\Authorization\Method\AbstractMethod */
