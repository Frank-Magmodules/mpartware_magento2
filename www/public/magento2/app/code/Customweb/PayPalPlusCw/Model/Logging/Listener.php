...
namespace Customweb\PayPalPlusCw\Model\Logging;
...
class Listener implements \Customweb_Core_Logger_IListener {
	 ...
	 * @var string
	 */
	protected $fileName = '/var/log/paypalpluscw.log';
	...
	public function __construct(
		...
		$this->_logger = new Logger('paypalpluscw');
	...
	private function isLevelActive($level) {
		switch ($this->_scopeConfig->getValue('paypalpluscw/logging/level')) {
			case 'debug':
				return true;
			case 'info':
