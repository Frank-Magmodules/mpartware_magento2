...
namespace Customweb\PayPalPlusCw\Model\Alias;
...
class Handler
{
	 ...
	 */
	public function getAliasTransactions(\Customweb\PayPalPlusCw\Model\Authorization\OrderContext $orderContext)
	{
	 ...
	 */
	public function removeSimilarAliases(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function removeAlias(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function deactivateAlias(\Customweb\PayPalPlusCw\Model\Authorization\Transaction $transaction)
	{
		$transaction->setAliasActive(false);
		$transaction->save();
	}
