...
class AuthorizationData implements \Customweb\PayPalPlusCw\Api\Data\AuthorizationDataInterface {
	...
	public function setHiddenFormFields(array $hiddenFormFields)
	{
		...
		foreach ($hiddenFormFields as $key => $value) {
			$field = new \Customweb\PayPalPlusCw\Model\Service\AuthorizationFormField();
