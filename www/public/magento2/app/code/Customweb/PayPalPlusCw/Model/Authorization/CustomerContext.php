 ...
 * @method \Customweb\PayPalPlusCw\Model\Authorization\CustomerContext setContextId(string $value)
 * @method string getCustomerId()
 * @method \Customweb\PayPalPlusCw\Model\Authorization\CustomerContext setCustomerId(string $value)
 * @method array getValues()
 * @method \Customweb\PayPalPlusCw\Model\Authorization\CustomerContext setValues(array $value)
 * @method int getVersionNumber()
 * @method \Customweb\PayPalPlusCw\Model\Authorization\CustomerContext setVersionNumber(int $value)
 */
class CustomerContext extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_Authorization_IPaymentCustomerContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_paypalpluscw_customer_context';
	 ...
	 * @param \Customweb\PayPalPlusCw\Model\Authorization\CustomerContextFactory $factory
	...
	public function __construct(
			...
			\Customweb\PayPalPlusCw\Model\Authorization\CustomerContextFactory $factory,
    ...
    {
        $this->_init('Customweb\PayPalPlusCw\Model\ResourceModel\Authorization\CustomerContext');
     ...
     * @return \Customweb\PayPalPlusCw\Model\Authorization\CustomerContext
     */
