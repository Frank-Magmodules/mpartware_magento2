...
class Factory
{
     ...
     */
    public function create(\Customweb\PayPalPlusCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\PayPalPlusCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\PayPalPlusCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\PayPalPlusCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\PayPalPlusCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\PayPalPlusCw\Model\Authorization\Method\Context\Factory
     */
