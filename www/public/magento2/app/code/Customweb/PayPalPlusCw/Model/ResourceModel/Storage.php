...
namespace Customweb\PayPalPlusCw\Model\ResourceModel;
...
class Storage extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_paypalpluscw_storage_resource';
    ...
    {
        $this->_init('customweb_paypalpluscw_storage', 'key_id');
    }
