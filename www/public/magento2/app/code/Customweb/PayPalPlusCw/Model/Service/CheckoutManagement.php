...
class CheckoutManagement implements \Customweb\PayPalPlusCw\Api\CheckoutManagementInterface
{
	/**
	...
	/**
	 *
	 * @var \Customweb\PayPalPlusCw\Model\Payment\Method\ConfigProvider
	 */
	 ...
	 * @param \Customweb\PayPalPlusCw\Model\Payment\Method\ConfigProvider $configProvider
	...
	public function __construct(
		...
		\Customweb\PayPalPlusCw\Model\Payment\Method\ConfigProvider $configProvider,
     ...
     * @param int $alias
     * @return string
     * @throws \Customweb\PayPalPlusCw\Model\Exception\OptimisticLockingException
     */
    ...
    /**
     *
     * @param \Customweb\PayPalPlusCw\Api\Data\AuthorizationFormFieldInterface[] $formValues
     * @return NULL|string[]
     */
    protected function convertFormValuesToMap(array $formValues = null) {
    		...
    		foreach ($formValues as $formValue) {
    			/* @var \Customweb\PayPalPlusCw\Api\Data\AuthorizationFormFieldInterface $formValue */
