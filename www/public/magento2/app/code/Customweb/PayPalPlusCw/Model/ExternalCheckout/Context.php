...
namespace Customweb\PayPalPlusCw\Model\ExternalCheckout;

/**
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	...
	/**
	 * @var \Customweb\PayPalPlusCw\Helper\InvoiceItem
	 */
	protected $_invoiceItemHelper;

	/**
	 * @var \Customweb\PayPalPlusCw\Helper\FoomanSurcharge
	 */
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_paypalpluscw_external_checkout_context';
	...
	/**
	 * @var \Customweb\PayPalPlusCw\Model\Payment\Method\AbstractMethod
	 */
	 ...
	 * @param \Customweb\PayPalPlusCw\Helper\InvoiceItem $invoiceItemHelper
	 * @param \Customweb\PayPalPlusCw\Helper\FoomanSurcharge $foomanSurchargeHelper
	...
	public function __construct(
			...
			\Customweb\PayPalPlusCw\Helper\InvoiceItem $invoiceItemHelper,
			\Customweb\PayPalPlusCw\Helper\FoomanSurcharge $foomanSurchargeHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\PayPalPlusCw\Model\ResourceModel\ExternalCheckout\Context');
    }
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\PayPalPlusCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\PayPalPlusCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\PayPalPlusCw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\PayPalPlusCw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\PayPalPlusCw\Model\Payment\Method\AbstractMethod) {
			$data = [
