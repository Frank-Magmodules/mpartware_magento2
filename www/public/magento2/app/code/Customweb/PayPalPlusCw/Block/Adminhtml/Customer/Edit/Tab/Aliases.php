...
namespace Customweb\PayPalPlusCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\PayPalPlusCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\PayPalPlusCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\PayPalPlusCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('paypalpluscw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('paypalpluscw/customer/aliases', ['_current' => true]);
    }
