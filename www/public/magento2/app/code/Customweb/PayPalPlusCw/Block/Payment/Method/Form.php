...
namespace Customweb\PayPalPlusCw\Block\Payment\Method;
...
class Form extends \Magento\Payment\Block\Form
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_PayPalPlusCw::payment/method/form.phtml';
	...
	public function getPaymentForm()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_PayPalPlusCw_License::run('7n0pkgdhohveklus', $this, $arguments);
	}

	final public function call_9q81m4t627hkfoqr() {
	...
	private function getFormRenderer() {
		return new \Customweb\PayPalPlusCw\Model\Renderer\CheckoutForm($this->getMethodCode());
	}
