...
namespace Customweb\PayPalPlusCw\Block\Checkout;
...
class AbstractCheckout extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @return \Customweb\PayPalPlusCw\Block\Checkout\AbstractCheckout
	 */
	...
	/**
	 * @param \Customweb\PayPalPlusCw\Model\Authorization\Method\AbstractMethod $adapter
	 * @return \Customweb\PayPalPlusCw\Block\Checkout\AbstractCheckout
	 */
	public function setAuthorizationAdapter(\Customweb\PayPalPlusCw\Model\Authorization\Method\AbstractMethod $adapter)
	{
	...
	{
		if (!($this->authorizationAdapter instanceof \Customweb\PayPalPlusCw\Model\Authorization\Method\AbstractMethod)) {
