...
namespace Customweb\PayPalPlusCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('paypalpluscw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('paypalpluscw_transaction');
	}
	...
	{
		return $this->getUrl('paypalpluscw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('paypalpluscw/transaction/');
	}
}