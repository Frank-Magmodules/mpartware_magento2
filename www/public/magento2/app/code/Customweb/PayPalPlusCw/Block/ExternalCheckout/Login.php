...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_PayPalPlusCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('paypalpluscw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('paypalpluscw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('paypalpluscw/externalCheckout/registerPost', ['_secure' => true]);
	}
