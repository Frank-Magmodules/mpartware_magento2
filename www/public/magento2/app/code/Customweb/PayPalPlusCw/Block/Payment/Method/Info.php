...
class Info extends \Magento\Payment\Block\Info
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_PayPalPlusCw::payment/method/info.phtml';
	...
	public function getMethod()
	{
		...
		if ($this->getTransaction() instanceof \Customweb\PayPalPlusCw\Model\Authorization\Transaction) {
	...
	{
		return $this->getUrl('paypalpluscw/transaction/view', ['transaction_id' => $this->getTransaction()->getId()]);
	}
